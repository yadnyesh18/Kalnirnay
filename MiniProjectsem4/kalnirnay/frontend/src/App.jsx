...
import SmartChecklists from './components/SmartChecklists'
import BentoPlanning from './components/BentoPlanning'
...
function MainApp({ user, onLogout, onUserUpdate }) {
  ...
  const [isDark, setIsDark] = useState(() => {
    return localStorage.getItem('kn_theme') !== 'light'
  })
  const toggleTheme = () => {
    setIsDark(prev => {
      const next = !prev
    ...
    <div className="app" data-theme={isDark ? 'dark' : 'light'}>
      ...
      <main className="main">
        ...
        <div className="tab-bar">
          {[['calendar','Calendar'],['countdowns','Exam Countdowns'],['checklists','Smart Checklists'],['bento','Bento Planning']].map(([key, label]) => (
        ...
        {loading ? (
          ...
          <>
                ...
                <div className="events-list">
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
                    ...
                    <select
                      ...
                      style={{ padding: '0.4rem 0.75rem', borderRadius: '8px', border: '1px solid var(--border)', background: 'var(--bg3)', color: 'var(--text)', fontSize: '0.85rem', cursor: 'pointer', outline: 'none' }}
                    >
            ...
            {activeTab === 'countdowns' && (
              <div className="feature-section">
                <div className="feature-section-header">
                  ...
                  <p className="feature-section-sub">Days remaining for your upcoming events</p>
                </div>
                <ExamCountdowns events={events} />
              </div>
            )}
            ...
            {activeTab === 'bento' && (
              <div className="feature-section">
                <div className="feature-section-header">
                  <h2 className="section-title">Bento Planning</h2>
                  <p className="feature-section-sub">Track progress across all your subjects this semester</p>
                </div>
                <BentoPlanning user={user} />
              </div>
            )}
          </>
        )}
